...
public class multiplicacaoTestJUnit {
	...
	public void calculodemuliplicacao() {
		...
		Assert.assertEquals(56, mult);//o valor colocado junto do comando mult, é para validar o valor, sendo assim o resultado do calculo acima é 56.
		
		
		mult = calc.multiplicacao(9, 0);//calculo da multiplicação de dois valores sendo um deles igual a zero.
		
		Assert.assertEquals(0, mult);//o valor colocado junto do comando mult, é para validar o valor, sendo assim o resultado do calculo acima é 0.
	
		
		
		mult = calc.multiplicacao(5, 1);//calculo da multiplicação de dois valores sendo um deles igual a 1.
		
		Assert.assertEquals(5, mult);//o valor colocado junto do comando mult, é para validar o valor, sendo assim o resultado do calculo acima é 10.
